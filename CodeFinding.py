...
CodeFinding.py - Find the frequency set
"""
...
def CodeFinding(input_dir, shape_height, shape_width, output_dir, start):
    ...
    for i in range(round_total):
        ...
        print('\rThe %d round of searching has been completed, the total number of codewords is %d，delete number is %d, the program has run %s' % (round_num + 1, len(codebook), delnum, end - start),
              end=' ')
